...
const TechBlogCard = () => {
    return ( <div className="font-primary rounded-md p-4 bg-white flex flex-col gap-2 text-foreground">
        <div className="text-sm font-semibold text-gray-950">01/ This Blog</div>
        ...
        <div className=" text-sm  flex items-center text-gray-950"><PageLink name='Read Article'/><ArrowUpRight size={18} /></div>
